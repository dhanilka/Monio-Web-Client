...
function Login() {
  ...
  return (
    ...
    <div className="">
      <div className="w-11/12  mx-auto pt-3 h-screen ">
        {/* Login area */}
        <div className="w-1/2 mx-auto h-auto ">
         
          <div className="bg-gray-950 h-5/6 pt-8 mt-10 rounded-lg">
          
            <div className="flex justify-center">
              <img className="w-7 h-7 mr-2" src={logo} alt="" />
              <p className="text-white font-bold text-3xl"> Monio Login</p>
            </div>

            <div className="pt-4">
                <p className="text-white text-center">Don't have an account ? <span className="text-blue-500 font-bold cursor-pointer hover:text-blue-400"> <Link to='/register'>Register</Link> </span> </p>
            </div>
 ...
 <div className="mb-1 relative">
    ...
    <div className="pb-2">
        <p className="text-blue-800 font-bold text-sm text-end hover:text-blue-500 cursor-pointer">Forgot password ?</p>
    </div>
